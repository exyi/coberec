...
\def\ThesisTitle{Transparent Restarts of Stateless Linux Services}
...
\def\Supervisor{Mgr. Michal Koutný}

% Supervisor's department (again according to Organizational structure of MFF)
\def\SupervisorsDepartment{SUSE LINUX, s. r. o.}
...
\def\Keywords{%
{transparent restart} {systemd} {libzedr} {zero-downtime restart}
}
