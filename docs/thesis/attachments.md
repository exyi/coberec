...
| `doxygen/html` | API reference generated by Doxygen in HTML format |

The project may be also found on GitHub: \url{https://github.com/exyi/coberec}. The thesis is also available one the web: \url{https://github.com/exyi/coberec/blob/master/docs/thesis/intro.md}
